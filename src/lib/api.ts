...
export const appointmentsAPI = {
  ...
  getTimeSlots: (date: string, department?: string, doctorId?: string, departmentId?: string, hospitalId?: string) => 
    api.get<APIResponse<string[]>>('/admin-appointments/slots', { params: { date, department, doctorId, departmentId, hospitalId } }),
...
export const patientsAPI = {
  ...
  getMe: () => api.get<APIResponse<any>>('/patients/me'),
