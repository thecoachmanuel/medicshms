...
function RadiologyRequestsContent() {
  const { user } = useAuth();
...
export default function RadiologyRequestsPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center animate-pulse font-black uppercase tracking-widest text-xs text-gray-400">Loading Radiology Informatics...</div>}>
      <RadiologyRequestsContent />
    </Suspense>
  );
}
